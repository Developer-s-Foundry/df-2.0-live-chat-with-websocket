...
const models: TsoaRoute.Models = {
    "Pick_mongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.Exclude_keyofmongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.__v__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_mongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.__v_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_mongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.Exclude_keyofmongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.__v__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "mongoose.Document_unknown.__.IUser.__.___": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_mongoose.ObjectIdToString_mongoose.FlattenMaps_mongoose.Require_id_DocType-and-TVirtuals___.__v_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IUser": {
        "dataType": "refAlias",
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/users/upgrade/:userId',
            ...
            async function UserController_upgradeToAgent(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_upgradeToAgent, request, response });

                const controller = new UserController();

              await templateService.apiHandler({
                methodName: 'upgradeToAgent',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserController_fetchUsersByRole: Record<string, TsoaRoute.ParameterSchema> = {
                role: {"in":"path","name":"role","required":true,"dataType":"string"},
        };
        app.get('/api/users/role/:role',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.fetchUsersByRole)),

            async function UserController_fetchUsersByRole(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_fetchUsersByRole, request, response });

                const controller = new UserController();

              await templateService.apiHandler({
                methodName: 'fetchUsersByRole',
                controller,
                response,
                next,
                validatedArgs,
        ...
        app.get('/api/users/get-all-users/:userId',
            ...
            async function UserController_fetchAllUsers(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_fetchAllUsers, request, response });
